...
class PoemsControllerTest < ActionController::TestCase
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post :create, poem: { author_id: @poem.author_id, html: @poem.html, license_id: @poem.license_id, markup: @poem.markup, title: @poem.title, user_id: @poem.user_id }
    end
  ...
  test "should update poem" do
    patch :update, id: @poem, poem: { author_id: @poem.author_id, html: @poem.html, license_id: @poem.license_id, markup: @poem.markup, title: @poem.title, user_id: @poem.user_id }
    assert_redirected_to poem_path(assigns(:poem))
  end
